# This Makefile is for the pQuery extension to perl.
#
...
#     ABSTRACT => q[Perl Port of jQuery.js]
...
#     NO_META => q[1]
#     PL_FILES => {  }
#     PREREQ_PM => { HTML::TreeBuilder=>q[0] }
#     VERSION => q[0.06]
...
TO_INST_PM = lib/pQuery.pm \
	lib/pQuery/DOM.pm

PM_TO_BLIB = lib/pQuery/DOM.pm \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/pQuery/DOM.pm $(INST_MAN3DIR)/pQuery::DOM.$(MAN3EXT) \
	  lib/pQuery.pm $(INST_MAN3DIR)/pQuery.$(MAN3EXT) 
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Perl Port of jQuery.js</ABSTRACT>' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' \
	  lib/pQuery/DOM.pm blib/lib/pQuery/DOM.pm \
	  lib/pQuery.pm blib/lib/pQuery.pm 
